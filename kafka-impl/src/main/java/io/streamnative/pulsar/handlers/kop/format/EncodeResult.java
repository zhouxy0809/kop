...
public class EncodeResult {
    ...
    public void updateProducerStats(final TopicPartition topicPartition,
        ...
        executor.execute(() -> {
            ...
            statsLoggerForThisPartition.getCounter(MESSAGE_IN).add(numMessageCopy);
            statsLoggerForThisPartition.getCounter(PRODUCE_MESSAGE_CONVERSIONS).add(conversionCountCopy);
